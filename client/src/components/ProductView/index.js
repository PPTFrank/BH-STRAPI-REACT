      ...
      <Row>
        ...
        <Col sm="12" md="6">
          <CardBody>
            ...
            <CardSubtitle>
              <strong>Giá: {attributes.price} VND</strong>
            </CardSubtitle>
            <CardSubtitle>Còn {attributes.quantity}</CardSubtitle>
            <div>
              <CardSubtitle>Kích cỡ:</CardSubtitle>
              <div className="sizes">
            ...
            <div>
              <CardSubtitle>Màu: {selectedColor}</CardSubtitle>
              ...
              <FormGroup className="quantity">
                <Label for="exampleSelect">Số lượng</Label>
                <Input
